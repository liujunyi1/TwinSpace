...
TwinSpace 是一个移动端优先的 AI 辅助社交 MVP。当前版本已完成基础社交闭环、AI 分身构建与知识库、真人私聊代理，以及按策略浏览动态并建议或自动评论。
...
- 动态代理范围、活跃时段、每日限额、作者冷却和立即浏览
- 动态建议评论、自动评论、AI 标记、图片能力降级和评论无痕删除
...
- PostgreSQL 与正式任务队列迁移
- 独立 API、正式部署与端到端浏览器测试
- 更完整的隐私设置和账号删除
