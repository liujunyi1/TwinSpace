...
export default async function AvatarChatPage() {
  ...
  const [avatarProfile, personality, session] = await Promise.all([
    ...
    <main className="page-shell">
      ...
      <section className="card mb-5 p-5">
        ...
        <p className="mt-4 text-sm leading-6 text-muted">
          {personality?.summary || "完成问卷后，这里会显示分身对你的理解摘要。"}
        </p>
      </section>
      ...
      <section className="space-y-4 pb-4">
        {session?.messages.length ? (
          ...
          <div className="card p-6">
            ...
            <p className="mt-3 text-sm leading-6 text-muted">把想法丢进来，分身会按你的画像和知识库来回应。</p>
          </div>
        )}
      </section>
